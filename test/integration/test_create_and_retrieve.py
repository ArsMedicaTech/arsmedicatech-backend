...
def test_create_and_retrieve():
    ...
    if created_patient:
        print(
            f"Successfully created patient: {created_patient.get('first_name')} {created_patient.get('last_name')}"
        )
        ...
        if retrieved_patient:
            print(
                f"Successfully retrieved patient: {retrieved_patient.get('first_name')} {retrieved_patient.get('last_name')}"
            )
        else:
