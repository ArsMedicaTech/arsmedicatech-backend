# ArsMedicaTech Backend

For significantly more details, view the [README for our central repository](https://github.com/ArsMedicaTech/arsmedicatech).

## Brief Overview

This repository is our central Python Flask backend which coordinates with various other backend services, such as the [MCP layer](https://github.com/ArsMedicaTech/arsmedicatech-mcp).
